...
<html lang="en">
    <head>
        ...
        <title>OVOO-Movie &amp; Video Steaming CMS Installation</title>
                            ...
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="email" class=" col-md-3">Username/Email</label>
                                            <div class=" col-md-9">
                                                <input type="text" value="" name="email" class="form-control" placeholder="Your username/email" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Enter anything ..." />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="section">
                                ...
                                <a class="go-to-login-page" href="<?php echo $dashboard_url; ?>">
                                    <div class="text-center">
										...
										more srcipts at <a target="_blank" href="https://prowebber.ru/">PROWEBBER.RU</a>
                                    </div>
                                </a>
                            </div>
